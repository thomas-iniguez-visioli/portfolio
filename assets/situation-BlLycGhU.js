import { _ as _export_sfc, t as temp, o as onMounted, a as openBlock, c as createElementBlock, r as renderSlot, b as createBaseVNode, d as createVNode, w as withCtx, F as Fragment, e as createTextVNode } from "./index-Dx-B2SB4.js";
import { D as DocumentationIcon } from "./IconDocumentation-DAXHMWh4.js";
const _hoisted_1 = {
  href: "/",
  id: "redirect"
};
      ...
      Object.keys(document.getElementsByTagName("a")).map((ite) => {
        ...
        if (item.id) {
          ...
          if (!item.href.includes("situation")) {
            item.href = item.href + "portfolio/local/situation/" + item.textContent.split("/")[item.textContent.split("/").length - 1];
          }
          log.info(item.href);
        }
      });
...
const WelcomeItem = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-c0d0f4c8"]]);
const _sfc_main$1 = {
  __name: "situation",
  setup(__props) {
    return (_ctx, _cache) => {
