import { _ as _export_sfc, t as temp, o as onMounted, a as openBlock, c as createElementBlock, r as renderSlot, b as createBaseVNode, d as createVNode, w as withCtx, F as Fragment, e as createTextVNode } from "./index-SyX3KXsn.js";
import { D as DocumentationIcon } from "./IconDocumentation-CnIarLSO.js";
const _hoisted_1 = {
  href: "/",
  id: "redirect"
};
    ...
    onMounted(() => {
      Object.keys(document.getElementsByTagName("a")).map((ite) => {
        ...
        if (item.id) {
          ...
          item.href = window.location.href + "/portfolio/situation/" + item.textContent.split("/")[item.textContent.split("/").length - 1];
          log.info(item.href);
        }
      });
    });
...
const WelcomeItem = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-cb3504a6"]]);
const _sfc_main$1 = {
  __name: "situation",
  setup(__props) {
    return (_ctx, _cache) => {
