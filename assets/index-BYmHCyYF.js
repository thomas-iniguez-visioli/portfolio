const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HomeView-CRsHJU5e.js","assets/IconDocumentation-D4ofpERD.js","assets/HomeView-CaNXXK5g.css","assets/situation-BoTQZvBV.js","assets/situation-DNpq39rx.css","assets/AboutView-_76eHh1x.js","assets/AboutView-DNtNIo95.css","assets/projectView-E6-tkyLj.js","assets/projectView-Do52k5X6.css"])))=>i.map(i=>d[i]);
(function polyfill() {
...
function moveTeleport(vnode, container, parentAnchor, { o: { insert }, m: move }, moveType = 2) {
  ...
  const { el: el2, anchor, shapeFlag, children: children2, props } = vnode;
...
function elementIsVisibleInViewport(el2) {
  const { top: top2, left, bottom: bottom2, right } = el2.getBoundingClientRect();
  const { innerHeight, innerWidth } = window;
  return (top2 > 0 && top2 < innerHeight || bottom2 > 0 && bottom2 < innerHeight) && (left > 0 && left < innerWidth || right > 0 && right < innerWidth);
}
  ...
  setup(props, { slots }) {
    ...
    return () => {
      ...
      const name = getComponentName(
        isAsyncWrapper(vnode) ? vnode.type.__asyncResolved || {} : comp2
      );
...
function normalizePropsOptions(comp2, appContext, asMixin = false) {
  ...
  if (isArray$1(raw)) {
    ...
    for (const key in raw) {
      ...
      if (validatePropName(normalizedKey)) {
        const opt = raw[key];
        const prop2 = normalized[normalizedKey] = isArray$1(opt) || isFunction(opt) ? { type: opt } : extend({}, opt);
...
class VueElement extends BaseClass {
   ...
   * @internal
   */
  _injectChildStyle(comp2) {
    this._applyStyles(comp2.styles, comp2);
  }
  /**
   * @internal
   */
  _removeChildStyle(comp2) {
  }
}
...
function requireUtility() {
  ...
  (function() {
    var assign2, getValue2, isArray2, isEmpty, isFunction2, isObject2, isPlainObject2, slice = [].slice, hasProp = {}.hasOwnProperty;
    assign2 = function() {
...
function requireXMLElement() {
  ...
  (function() {
    var NodeType2, XMLAttribute2, XMLNamedNodeMap2, XMLNode2, getValue2, isFunction2, isObject2, ref2, extend2 = function(child, parent) {
    ...
    ref2 = requireUtility(), isObject2 = ref2.isObject, isFunction2 = ref2.isFunction, getValue2 = ref2.getValue;
...
function requireXMLCData() {
  ...
  (function() {
    var NodeType2, XMLCharacterData2, extend2 = function(child, parent) {
      for (var key in parent) {
        if (hasProp.call(parent, key)) child[key] = parent[key];
      }
      function ctor() {
...
function requireXMLDeclaration() {
  ...
  (function() {
    var NodeType2, XMLNode2, isObject2, extend2 = function(child, parent) {
      for (var key in parent) {
        if (hasProp.call(parent, key)) child[key] = parent[key];
      }
      function ctor() {
...
function requireXMLDTDAttList() {
  ...
  (function() {
    var NodeType2, XMLNode2, extend2 = function(child, parent) {
      for (var key in parent) {
        if (hasProp.call(parent, key)) child[key] = parent[key];
      }
      function ctor() {
...
function requireXMLDocType() {
  ...
  (function() {
    var NodeType2, XMLDTDAttList2, XMLDTDElement2, XMLDTDEntity2, XMLDTDNotation2, XMLNamedNodeMap2, XMLNode2, isObject2, extend2 = function(child, parent) {
      for (var key in parent) {
        if (hasProp.call(parent, key)) child[key] = parent[key];
      }
      function ctor() {
...
function requireXMLNode() {
  ...
  (function() {
    var DocumentPosition2, NodeType2, XMLCData2, XMLComment2, XMLDeclaration2, XMLDocType2, XMLDummy2, XMLElement2, XMLNodeList2, XMLProcessingInstruction2, XMLRaw2, XMLText2, getValue2, isEmpty, isFunction2, isObject2, ref1, hasProp = {}.hasOwnProperty;
    ref1 = requireUtility(), isObject2 = ref1.isObject, isFunction2 = ref1.isFunction, isEmpty = ref1.isEmpty, getValue2 = ref1.getValue;
    XMLElement2 = null;
    XMLCData2 = null;
    XMLComment2 = null;
    ...
    XMLNode.exports = function() {
      ...
      XMLNode2.prototype.dtd = function(pubID, sysID) {
        var child, doc2, doctype, i, j, k, len, len1, ref2, ref3;
        doc2 = this.document();
...
function requireXMLStringWriter() {
  ...
  (function() {
    var XMLWriterBase2, extend2 = function(child, parent) {
      for (var key in parent) {
        if (hasProp.call(parent, key)) child[key] = parent[key];
      }
      function ctor() {
...
function requireXMLDocument() {
  ...
  (function() {
    var NodeType2, XMLDOMConfiguration2, XMLDOMImplementation2, XMLNode2, XMLStringWriter2, XMLStringifier2, isPlainObject2, extend2 = function(child, parent) {
      for (var key in parent) {
        if (hasProp.call(parent, key)) child[key] = parent[key];
      }
      function ctor() {
...
function requireXMLDocumentCB() {
  ...
  (function() {
    var NodeType2, WriterState2, XMLAttribute2, XMLCData2, XMLComment2, XMLDTDAttList2, XMLDTDElement2, XMLDTDEntity2, XMLDTDNotation2, XMLDeclaration2, XMLDocType2, XMLDocument2, XMLElement2, XMLProcessingInstruction2, XMLRaw2, XMLStringWriter2, XMLStringifier2, XMLText2, getValue2, isFunction2, isObject2, isPlainObject2, ref2, hasProp = {}.hasOwnProperty;
    ref2 = requireUtility(), isObject2 = ref2.isObject, isFunction2 = ref2.isFunction, isPlainObject2 = ref2.isPlainObject, getValue2 = ref2.getValue;
    NodeType2 = requireNodeType();
...
function requireXMLStreamWriter() {
  ...
  (function() {
    var NodeType2, WriterState2, XMLWriterBase2, extend2 = function(child, parent) {
      for (var key in parent) {
        if (hasProp.call(parent, key)) child[key] = parent[key];
      }
      function ctor() {
    ...
    XMLStreamWriter.exports = function(superClass) {
      ...
      XMLStreamWriter2.prototype.document = function(doc2, options) {
        ...
        for (i = j = 0, len = ref2.length; j < len; i = ++j) {
          child = ref2[i];
          child.isLastRootNode = i === doc2.children.length - 1;
        }
        options = this.filterOptions(options);
        ref1 = doc2.children;
        results = [];
...
function requireLib() {
  ...
  hasRequiredLib = 1;
  (function() {
    var NodeType2, WriterState2, XMLDOMImplementation2, XMLDocument2, XMLDocumentCB2, XMLStreamWriter2, XMLStringWriter2, assign2, isFunction2, ref2;
...
const Feed = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$1], ["__scopeId", "data-v-1be4218f"]]);
const _sfc_main$2 = {
  name: "VueRssFeed",
  components: {
    Feed
...
class VueLogger {
  ...
  async invokeHooks(hooks2, event) {
    if (hooks2 && hooks2.length > 0) {
      for (const hook of hooks2) {
        try {
  ...
  install(app2) {
    app2.provide(loggerSymbol, this);
    app2.config.globalProperties.$log = this;
    app2.config.globalProperties.$logger = this;
  }
}
logger$1.VueLogger = VueLogger;
...
hooks.StringifyAndParseObjectsHook = hooks.StringifyObjectsHook = void 0;
hooks.StringifyObjectsHook = {
  run(event) {
...
hooks.StringifyAndParseObjectsHook = {
  run(event) {
    for (let i = 0; i < event.argumentArray.length; i++) {
      if (event.argumentArray[i] != null && typeof event.argumentArray[i] === "object") {
        ...
        createBaseVNode("header", null, [
          ...
          createBaseVNode("div", _hoisted_1, [
            ...
            createVNode(VueRssFeed, {
              feedUrl: _ctx.bonjourlafuite.eu.org / _ctx.feed.xml,
              name: _ctx.rgpd,
              limit: 5
            }, null, 8, ["feedUrl", "name"]),
            createBaseVNode("nav", null, [
              ...
              createVNode(unref(RouterLink), { to: "/situation" }, {
                default: withCtx(() => _cache[2] || (_cache[2] = [
                  createTextVNode("situation professionelle")
                ])),
                _: 1
              })
            ])
...
const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c4f3e76d"]]);
  ...
  routes: [
    {
      path: "/",
      name: "home",
      component: () => __vitePreload(() => import("./HomeView-CRsHJU5e.js"), true ? __vite__mapDeps([0,1,2]) : void 0)
    },
    {
      path: "/situation",
      name: "situation",
      component: () => __vitePreload(() => import("./situation-BoTQZvBV.js"), true ? __vite__mapDeps([3,1,4]) : void 0)
    },
    {
      path: "/cv",
      name: "about",
      ...
      component: () => __vitePreload(() => import("./AboutView-_76eHh1x.js"), true ? __vite__mapDeps([5,6]) : void 0)
    },
    {
      path: "/projet/RGPD",
      name: "projet-RGPD",
      ...
      // this generates a separate chunk (About.[hash].js) for this route
      // which is lazy-loaded when the route is visited.
      component: () => __vitePreload(() => import("./projectView-E6-tkyLj.js"), true ? __vite__mapDeps([7,8]) : void 0),
      props: () => {
