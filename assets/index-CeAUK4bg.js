const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HomeView-DFtwnGma.js","assets/HomeView-CbCtRGmN.css","assets/AboutView-CpOzDOAY.js","assets/AboutView-DNtNIo95.css","assets/projectView-fz6bBcqI.js","assets/projectView-D2hBl14a.css"])))=>i.map(i=>d[i]);
(function polyfill() {
  ...
  routes: [
    {
      path: "/",
      name: "home",
      component: () => __vitePreload(() => import("./HomeView-DFtwnGma.js"), true ? __vite__mapDeps([0,1]) : void 0)
    },
    {
      path: "/cv",
      name: "about",
      ...
      component: () => __vitePreload(() => import("./AboutView-CpOzDOAY.js"), true ? __vite__mapDeps([2,3]) : void 0)
    },
    {
      path: "/project/:name",
      name: "temp",
      ...
      // this generates a separate chunk (About.[hash].js) for this route
      // which is lazy-loaded when the route is visited.
      component: () => __vitePreload(() => import("./projectView-fz6bBcqI.js"), true ? __vite__mapDeps([4,5]) : void 0),
      props: (params) => {
